...
class MarketDataUpdateBidAskInt(BaseMessageType):
    def __init__(self,
                 symbol_id=None,
                 bid_price=None,
                 bid_quantity=None,
                 ...
                 ask_quantity=None,
                 date_time=None):
        self.Type = MessageTypes.MARKET_DATA_UPDATE_BID_ASK_INT
    ...
    def from_message_short(message_obj):
        ...
        return MarketDataUpdateBidAskInt(
             symbol_id=packet[0],
             bid_price=packet[1],
    ...
    def from_message(message_obj):
        if 'F' in message_obj:
            return MarketDataUpdateBidAskInt.from_message_short(message_obj)
        else:
            return MarketDataUpdateBidAskInt.from_message_long(message_obj)
