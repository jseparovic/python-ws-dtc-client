...
class MarketDataSnapshotInt(BaseMessageType):
    def __init__(self,
                 symbol_id=None,
                 ...
                 trading_status=None):
        self.Type = MessageTypes.MARKET_DATA_SNAPSHOT_INT
    ...
    def from_message(message_obj):
        if 'F' in message_obj:
            return MarketDataSnapshotInt.from_message_short(message_obj)
        else:
            return MarketDataSnapshotInt.from_message_long(message_obj)
