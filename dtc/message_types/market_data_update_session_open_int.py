...
class MarketDataUpdateSessionOpenInt(BaseMessageType):
    ...
    def from_message_short(message_obj):
        ...
        return MarketDataUpdateSessionOpenInt(
             symbol_id=packet[0],
             price=packet[1],
    ...
    def from_message(message_obj):
        if 'F' in message_obj:
            return MarketDataUpdateSessionOpenInt.from_message_short(message_obj)
        else:
            return MarketDataUpdateSessionOpenInt.from_message_long(message_obj)
